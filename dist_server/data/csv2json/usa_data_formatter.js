...
var dailyDataCsvFilePath = path.join(__dirname, '../../../', 'raw_data/csv/usa_daily.csv');
var statesDataCsvFilePath = path.join(__dirname, '../../../', 'raw_data/csv/usa_states.csv');
var totalDataCsvFilePath = path.join(__dirname, '../../../', 'raw_data/csv/usa_total.csv');
var infoPortalDataCsvFilePath = path.join(__dirname, '../../../', 'raw_data/csv/usa_states_info_portals.csv');
var dailyDataJsonFilePath = path.join(__dirname, '../../../', 'raw_data/json/usa_daily.json');
var statesDataJsonFilePath = path.join(__dirname, '../../../', 'raw_data/json/usa_states.json');
var totalDataJsonFilePath = path.join(__dirname, '../../../', 'raw_data/json/usa_total.json');
var infoPortalDataJsonFilePath = path.join(__dirname, '../../../', 'raw_data/json/usa_states_info_portals.json');
